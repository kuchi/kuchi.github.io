...
BLOG_AUTHOR = "Anthony Tanbakuchi"  # (translatable)
BLOG_TITLE = "Anthony Tanbakuchi"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tanbakuchi.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "webmaster@tanbakuchi.com"
BLOG_DESCRIPTION = "Personal site of Anthony Tanbakuchi, PhD."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/CV/TanbakuchiCV.pdf", "CV"),
        ("/stories/publications/", "Publications"),
        ("/stories/teaching/", "Teaching"),
        ("/stories/research/", "Research"),
...
REDIRECTIONS = [
    ...
    # Dissertation video permanent redirects
    ("permanent/dissertation/Ch3V1.mov/index.html", "https://youtu.be/ewLRWBptY3Q"),
    ("permanent/dissertation/Ch3V2.mov/index.html", "https://youtu.be/3c9ws2dsuwc"),
    ("permanent/dissertation/Ch3V3.mov/index.html", "https://youtu.be/HbQFZHAFMhY"),
    ("permanent/dissertation/Ch4V1.mov/index.html", "https://youtu.be/2zoCtMp-z4Y"),
    ("permanent/dissertation/Ch4V2.mov/index.html", "https://youtu.be/lX5hpmnh2_Q"),
    ("permanent/dissertation/Ch6V1.mov/index.html", "https://youtu.be/vyeBLgnfULk"),
    ]
